...
require('iconfontDir/font-awesome.min.css');
require('lessDir/base.less');
require('vendorDir/jPlayer/jplayer.flat.css');
// require('metisMenu/metisMenu.min');
require('bootstrap/dist/js/bootstrap.min.js');

require('vendorDir/promise.min');
require('vendorDir/jquery.slimscroll.min');
require('vendorDir/jPlayer/jquery.jplayer.min');
require('vendorDir/jPlayer/add-on/jplayer.playlist.min');
require('vendorDir/slider.min');
// require('vendorDir/jPlayer/demo');
